...
describe("numeric", () => {
  it("should resolve validation when given a valid value", async () => {
    ...
    await expect(result).toBe(result);
  });
  ...
  it("should reject validation when given an alphabet-only string", async () => {
    ...
    await expect(result).rejects.toEqual(new ValidationError(invalidMessage));
  });
...
describe("gt", () => {
  it("should reject validation when given value equal to boundary", async () => {
    ...
    await expect(result).rejects.toEqual(
      new ValidationError("window must be greater than 5.3")
    );
  });
  ...
  it("should reject validation when given null", async () => {
    ...
    await expect(result).rejects.toEqual(
      new ValidationError("window cannot be null")
    );
  });
...
describe("lt", () => {
  it("should reject validation when given value equal to boundary", async () => {
    ...
    await expect(result).rejects.toEqual(
      new ValidationError("window must be less than 5.3")
    );
  });
...
describe("gte", () => {
  ...
  it("should reject validation when given a smaller value", async () => {
    ...
    await expect(result).rejects.toEqual(
      new ValidationError("window must be greater than or equal to 5.3")
    );
  });
  ...
  it("should reject validation when less than ref", async () => {
    ...
    await expect(result).rejects.toEqual(
      new ValidationError(
        "maxWindow must be greater than or equal to minWindow"
      )
    );
  });
...
describe("lte", () => {
  ...
  it("should rejects validation when given a greater value", async () => {
    ...
    await expect(result).rejects.toEqual(
      new ValidationError("window must be less than or equal to 5.3")
    );
  });
  ...
  it("should reject validation when greater than ref", async () => {
    ...
    await expect(result).rejects.toEqual(
      new ValidationError("minWindow must be less than or equal to maxWindow")
    );
  });
  ...
  it("should reject validation when ref is invalid number", async () => {
    ...
    await expect(result).rejects.toEqual(
      new ValidationError(
        'maxWindow must be a `numeric` type, but the final value was: `"abc"`.'
      )
    );
  });
...
describe("eq", () => {
  ...
  it("should rejects validation when given a greater value", async () => {
    ...
    await expect(result).rejects.toEqual(
      new ValidationError("window must be equal to 5.3")
    );
  });
  ...
  it("should reject validation when greater than ref", async () => {
    ...
    await expect(result).rejects.toEqual(
      new ValidationError("minWindow must be equal to maxWindow")
    );
  });
...
describe("neq", () => {
  it("should resolves validation when given value not equal to boundary", async () => {
    const schema = object({
      window: numeric().neq(5.3),
    });
    const value = { window: "5.4" };
    const result = schema.validate(value);
  ...
  it("should reject validation when given an invalid value", async () => {
    const schema = object({
      window: numeric().neq(5.3).typeError(invalidMessage),
    });
    const value = { window: "sdfdf" };
    const result = schema.validate(value);
  ...
  it("should resolves validation when greater than ref", async () => {
    const schema = object({
      minWindow: numeric().neq(ref("maxWindow")),
      maxWindow: numeric(),
    });
    const value = {
      minWindow: "3.2",
      maxWindow: "3.19999999999999999999999999999999999",
    };
    const result = schema.validate(value);
  ...
  it("should reject validation when equal to ref", async () => {
    const schema = object({
      minWindow: numeric().neq(ref("maxWindow")),
      maxWindow: numeric(),
    });
    const value = {
      minWindow: "3.2000000000000001",
      maxWindow: "3.2000000000000001",
    };
    const result = schema.validate(value);

    await expect(result).rejects.toEqual(
      new ValidationError("minWindow must not be equal to maxWindow")
    );
  });
});
...
describe("integer", () => {
  ...
  it("should reject validation when given a non-integer", async () => {
    ...
    await expect(result).rejects.toEqual(
      new ValidationError("window must be an integer")
    );
  });
...
describe("isMoreThan", () => {
  ...
  it("should reject validation when given a smaller value", async () => {
    ...
    await expect(result).rejects.toEqual(
      new ValidationError("window must be more than 3")
    );
  });
  ...
  it("should reject validation when smaller than ref", async () => {
    ...
    await expect(result).rejects.toEqual(
      new ValidationError("maxWindow must be more than minWindow")
    );
  });
...
describe("isLessThan", () => {
  ...
  it("should reject validation when given a greater value", async () => {
    ...
    await expect(result).rejects.toEqual(
      new ValidationError("window must be less than 3")
    );
  });
  ...
  it("should reject validation when smaller than ref", async () => {
    ...
    await expect(result).rejects.toEqual(
      new ValidationError("minWindow must be less than maxWindow")
    );
  });
